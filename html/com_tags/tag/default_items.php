			...
			<?php else : ?>
				...
				<div class="card_item_content">
					...
					<?php if ($this->params->get('tag_list_show_item_description', 1)) : ?>
						...
						<?php
							$introtext  = strip_tags($item->core_body);
					...
					<footer>
						<p class="readmore">
							<a class="btn" href="<?php echo JRoute::_(TagsHelperRoute::getItemRoute($item->content_item_id, $item->core_alias, $item->core_catid, $item->core_language, $item->type_alias, $item->router)); ?>" itemprop="url"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
						</p>
					</footer>
...
<?php
	...
	if ($language == "en-GB") : ?>
		<p>
			<a href='<?php echo $url; ?>'><i class="fa fa-chevron-left" aria-hidden="true"></i> Back</a>
		</p>
	<?php else : ?>
		<p>
			<a href='<?php echo $url; ?>'><i class="fa fa-chevron-left" aria-hidden="true"></i> Retour</a>
		</p>
	<?php endif; ?>
