...
$labelClass = (!$showLabel ? 'hidden ' : '') . 'finder' . $suffix;
...
{
	$button = '<span class="input-group-btn"><button class="btn btn-default ' . $suffix . ' finder' . '" type="submit" title="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '"><i class="fa fa-search" aria-hidden="true"></i>' . '</button></span>';
